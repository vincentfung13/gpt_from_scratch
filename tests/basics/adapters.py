...
def run_transformer_lm(
    ...
    lm.token_embeddings.load_state_dict({"weights": weights["token_embeddings.weight"]})

    # Load the transformer layers
    ...
    lm.ln_final.load_state_dict({"weight": weights["ln_final.weight"]})
    lm.lm_head.load_state_dict({"weights": weights["lm_head.weight"]})
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    tokenizer.train(
        input_path,
        vocab_size,
        pre_tokenization_pattern=tokenizer.pre_tokenization_pattern,
        save_dir="pytest_bpe",
